...
const boxes = document.querySelectorAll(".box") as NodeListOf<HTMLButtonElement> ;
const resetButton = document.querySelector(".resetButton") as HTMLButtonElement;
const container = document.querySelector(".container") as HTMLDivElement;
const messageContainer = document.querySelector(".masgContainer") as HTMLDivElement;
const message = document.querySelector(".message") as HTMLHeadingElement ;
const newGameButton = document.querySelector(".newGameButton") as HTMLButtonElement;
...
function showWinner(winner:any) {
  container.style.display = "none";
  messageContainer.style.display = "flex";
